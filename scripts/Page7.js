...
function myFunction() {
  ...
  if ((x != " D O W N   T H E") && (y != " S O U T H   C O A S T")) {
    alert("You got it get whole word in.\nKeep going");
	return false;
  } else {
...
if(window.value === 0)
{
x = document.getElementById("image").src = "../Assets/Clothes.png";
window.value = 1;
}
if(window.value === 1)
{
x = document.getElementById("image").src = "../Assets/Sun.png";
window.value = 2;
}
}
...
function myFunctionA() {
  ...
  document.getElementById("inputText2").value = s;
...
function myFunctionH() {
  ...
  var t = document.getElementById("inputText2").value
  var index = 9;
  t = t.substr(0, index) + 'H' + t.substr(index + 1);
  document.getElementById("inputText2").value = t;
...
function myFunctionO() {
  ...
  document.getElementById("inputText2").value = t2;
